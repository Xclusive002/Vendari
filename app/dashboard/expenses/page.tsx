          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="dashboard-panel">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div><Label className="text-text-secondary">Amount (₦) *</Label><Input type="number" min="0" step="0.01" value={formData.amount} onChange={(event) => setFormData({ ...formData, amount: normalizeAmountInput(event.target.value) })} className="dashboard-input mt-1" required /></div>
