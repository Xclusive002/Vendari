...
export default function AccountMenu() {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && <div role="menu" aria-label="User menu" className="fixed left-4 right-4 top-[calc(env(safe-area-inset-top)+4.5rem)] z-50 max-h-[calc(100vh-env(safe-area-inset-top)-6rem)] overflow-y-auto rounded-xl border border-border bg-surface shadow-[var(--shadow-modal)] sm:absolute sm:inset-auto sm:bottom-auto sm:right-0 sm:top-12 sm:max-h-none sm:w-[min(20rem,calc(100vw-2rem))]">
