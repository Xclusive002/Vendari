    ...
    <div ref={containerRef} className="relative z-40">
      ...
      {open && (
        <>
          ...
          <div role="dialog" aria-label="Notifications" className="fixed inset-x-0 bottom-0 z-50 h-[85vh] overflow-hidden rounded-t-xl border-t border-border bg-surface shadow-2xl sm:absolute sm:inset-auto sm:bottom-auto sm:left-auto sm:right-0 sm:top-12 sm:h-auto sm:w-[min(22rem,calc(100vw-2rem))] sm:rounded-xl sm:border-t-0 sm:border">
